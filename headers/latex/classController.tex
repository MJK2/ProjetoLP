...
Um objeto \hyperlink{classDocumentario}{Documentario}. Pega as informacoes de um documentario, contidas no arquivo documentaroi.\+dat, transforma-\/os em um vector de strings e inicializa um objeto documentario partir deste vector. 
\end{DoxyReturn}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Um objeto filme. Pega as informacoes de um filme, contidas no arquivo filme.\+dat, transforma-\/os em um vector de strings e inicializa um objeto filme a partir deste vector. 
\end{DoxyReturn}
